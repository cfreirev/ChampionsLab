...
export const WINNING_TEAMS: WinningTeam[] = [
  ...
  },
  {
    ...
    player: "Emily Nguyen",
    placement: "2nd Place",
    event: "Champions Series Invitational #3",
    pokemon: [
      { pokemonId: 9, name: "Blastoise", isMega: true },
      { pokemonId: 186, name: "Politoed" },
      { pokemonId: 887, name: "Dragapult" },
      { pokemonId: 727, name: "Incineroar" },
      { pokemonId: 591, name: "Amoonguss" },
      { pokemonId: 423, name: "Gastrodon" },
    ],
  },
  {
    id: "t40",
  ...
  },
  {
    ...
    pokemon: [
      ...
      { pokemonId: 59, name: "Arcanine" },
      { pokemonId: 10335, name: "Hisuian Arcanine" },
      { pokemonId: 80, name: "Slowbro" },
      { pokemonId: 130, name: "Gyarados" },
    ],
  },
  ...
  {
    id: "e100",
    name: "Grimmsnarl Screens Support",
    player: "Engine Analysis",
    placement: "Top Cut",
    event: "2M Battle Simulation - High ELO",
    pokemon: [
  ...
  },
  {
    ...
    pokemon: [
      ...
      { pokemonId: 983, name: "Kingambit" },
      { pokemonId: 36, name: "Clefable" },
      { pokemonId: 812, name: "Rillaboom" },
    ],
  },
  {
    id: "e104",
    name: "Sheer Force Rush",
    player: "Engine Analysis",
    placement: "Top 8",
    event: "2M Battle Simulation - High ELO",
    pokemon: [
  ...
  },
  {
    ...
    pokemon: [
      { pokemonId: 351, name: "Castform" },
      { pokemonId: 38, name: "Ninetales" },
      { pokemonId: 3, name: "Venusaur", isMega: true },
      { pokemonId: 445, name: "Garchomp" },
      { pokemonId: 727, name: "Incineroar" },
      { pokemonId: 812, name: "Rillaboom" },
    ],
