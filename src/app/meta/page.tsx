...
const ML_POKEMON_RANKINGS = [
  { name: "Gyarados",     elo: 78724, wr: 50.7, games: 723243 },
  { name: "Torkoal",      elo: 71988, wr: 52.5, games: 176239 },
  { name: "Slowbro",      elo: 69100, wr: 58.4, games: 50548 },
  { name: "Rhyperior",    elo: 63884, wr: 52.8, games: 141742 },
  { name: "Archaludon",   elo: 57220, wr: 65.5, games: 22537 },
  { name: "Snorlax",      elo: 46388, wr: 62.0, games: 23369 },
  { name: "Spiritomb",    elo: 44100, wr: 54.6, games: 58015 },
  { name: "Venusaur",     elo: 37220, wr: 51.3, games: 165635 },
  { name: "Gengar",       elo: 28588, wr: 50.5, games: 358744 },
  { name: "Azumarill",    elo: 28044, wr: 52.1, games: 77480 },
  { name: "Kingambit",    elo: 26948, wr: 50.4, games: 449591 },
  { name: "Krookodile",   elo: 25780, wr: 52.8, games: 54831 },
  { name: "Charizard",    elo: 24948, wr: 56.3, games: 23283 },
  { name: "Hydreigon",    elo: 23900, wr: 54.4, games: 32034 },
  { name: "Heat Rotom",   elo: 15116, wr: 70.7, games: 4110 },
  { name: "Meganium",     elo: 14500, wr: 51.2, games: 18200 },
  { name: "Hisuian Zoroark", elo: 13800, wr: 52.1, games: 15400 },
  { name: "Mamoswine",    elo: 13200, wr: 53.8, games: 12800 },
  { name: "Scizor",       elo: 12600, wr: 52.4, games: 14200 },
  { name: "Sylveon",      elo: 12100, wr: 51.8, games: 13600 },
];

const ML_BEST_MOVES = [
  { name: "Icicle Crash",   wr: 66.5, uses: 4368 },
  { name: "Ice Shard",      wr: 66.5, uses: 4368 },
  { name: "Heal Pulse",     wr: 66.5, uses: 4368 },
  { name: "Electro Shot",   wr: 65.5, uses: 22537 },
  { name: "Body Slam",      wr: 62.7, uses: 27737 },
  { name: "Body Press",     wr: 62.3, uses: 28041 },
  { name: "High Horsepower",wr: 62.0, uses: 23369 },
  { name: "Curse",          wr: 62.0, uses: 23369 },
  { name: "Air Slash",      wr: 59.7, uses: 12328 },
  { name: "Volt Switch",    wr: 58.0, uses: 10235 },
];

const ML_ARCHETYPES = [
  { name: "Slowbro Trick Room", elo: 23652, wr: 65.9 },
  { name: "Sun Hyper Offense",  elo: 13092, wr: 66.2 },
  { name: "Hard Trick Room",    elo: 25692, wr: 60.2 },
  { name: "Sun Trick Room",     elo: 25796, wr: 51.5 },
  { name: "Goodstuffs",         elo: 12356, wr: 51.0 },
  { name: "Sun",                elo: 11868, wr: 51.4 },
  { name: "Bulky Balance",      elo: 8412,  wr: 52.5 },
  { name: "Mega Gardevoir",     elo: 7620,  wr: 51.1 },
  { name: "Balance",            elo: 7460,  wr: 51.6 },
];

const ML_BEST_CORES = [
  { pair: "Charizard + Archaludon",   wr: 81.8, games: 3577 },
  { pair: "Charizard + Toxapex",      wr: 81.8, games: 3577 },
  { pair: "Krookodile + Archaludon",  wr: 81.8, games: 3577 },
  { pair: "Toxapex + Archaludon",     wr: 81.8, games: 3577 },
  { pair: "Whimsicott + Archaludon",  wr: 75.9, games: 7687 },
  { pair: "Gyarados + Heat Rotom",    wr: 70.7, games: 4110 },
  { pair: "Archaludon + Heat Rotom",  wr: 70.7, games: 4110 },
  { pair: "Whimsicott + Heat Rotom",  wr: 70.7, games: 4110 },
];

const ML_INSIGHTS = [
  { type: "meta" as const, text: "Top meta threats: Gyarados (50.7% WR, 78724 ELO), Torkoal (52.5% WR, 71988 ELO), Slowbro (58.4% WR, 69100 ELO)", confidence: 95 },
  { type: "synergy" as const, text: "Strongest cores: Charizard + Archaludon (81.8%), Charizard + Toxapex (81.8%), Krookodile + Archaludon (81.8%)", confidence: 90 },
  { type: "counter" as const, text: "Rain Offense hard-counters Standard (70.2% WR over 265 games)", confidence: 85 },
  { type: "counter" as const, text: "Sand hard-counters Tailwind Offense (79.1% WR over 2352 games)", confidence: 85 },
  { type: "counter" as const, text: "Mega Kangaskhan hard-counters Dragapult Tailwind (75.5% WR over 445 games)", confidence: 85 },
  { type: "pokemon" as const, text: "Overrated Pokémon (high usage, low WR): Flareon (34.5%)", confidence: 80 },
  { type: "meta" as const, text: "Highest win-rate moves: Icicle Crash (66.5%), Ice Shard (66.5%), Heal Pulse (66.5%), Electro Shot (65.5%)", confidence: 85 },
];
